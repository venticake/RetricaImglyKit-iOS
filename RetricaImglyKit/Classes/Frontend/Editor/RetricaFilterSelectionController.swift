 ...
 */
@available(iOS 8, *)
@objc(IMGLYRetricaFilterSelectionController) public class RetricaFilterSelectionController: NSObject {
    ...
    */
    ...
    public init(inputImage: UIImage?) {
        ...
        flowLayout.itemSize = RetricaFilterSelectionController.FilterCollectionViewCellSize
        ...
        collectionView.registerClass(FilterCollectionViewCell.self, forCellWithReuseIdentifier: RetricaFilterSelectionController.FilterCollectionViewCellReuseIdentifier)
...
@available(iOS 8, *)
extension RetricaFilterSelectionController: UICollectionViewDataSource {
    /**
     :nodoc:
     */
    ...
    public func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier(RetricaFilterSelectionController.FilterCollectionViewCellReuseIdentifier, forIndexPath: indexPath)
...
@available(iOS 8, *)
extension RetricaFilterSelectionController: UICollectionViewDelegate {
    /**
     :nodoc:
     */
