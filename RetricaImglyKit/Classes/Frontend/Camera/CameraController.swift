...
@objc(IMGLYCameraController) public class CameraController: NSObject {
    ...
    public var photoEffectIntensity: CGFloat {
        get {
    ...
    */
    ...
    private func addSessionObservers() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self,
            selector: #selector(CameraController.sessionRuntimeError(_:)),
            name: AVCaptureSessionRuntimeErrorNotification,
            object: session
        )

        NSNotificationCenter.defaultCenter().addObserver(self,
            selector: #selector(CameraController.sessionWasInterrupted(_:)),
            name: AVCaptureSessionWasInterruptedNotification,
            object: session
        )

        NSNotificationCenter.defaultCenter().addObserver(self,
            selector: #selector(CameraController.sessionInterruptionEnded(_:)),
